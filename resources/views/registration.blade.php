...
@endphp--}}
 <div class="form-group">
    ...
    <input type="text" class="form-control" name="name" placeholder="Enter Your Name" style="background-color:#FFF8DC; opacity:100%;" >
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" name="mob"  placeholder="Enter Your Mobile Number" style="background-color:#FFF8DC; opacity:100%;" >
    <span class="text-danger">
      @error('mob')
          {{$message}}
      @enderror
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="userid" value="" placeholder="Enter an User-ID" style="background-color:#FFF8DC; opacity:100%;" >
    <span class="text-danger">
      @error('userid')
          {{$message}}
      @enderror
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" name="password_confirmation" placeholder="Confirm Password" style="background-color:#FFF8DC;opacity:100%;">
    <span class="text-danger">
